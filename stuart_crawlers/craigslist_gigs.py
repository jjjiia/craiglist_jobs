...
def get_latest():
    ...
    for i in range(14):
        ...
        filename = "data/gigs/"+city+"/"+city+"_"+prevday+".csv"
        print filename
...
def download_craigslist(page_count = 1, limit = 5):
    ...
    for i in range(page_count):
        link = 'http://'+city+'.craigslist.org/ggg/index' + str(i*100) + '.html'
...
for city in cities:
    ...
    if not os.path.exists("data/gigs/"+city):
        os.makedirs("data/gigs/"+city)
    print city

    

    titles = []
    outputfile = open("data/gigs/"+city+"/new_"+city+"_"+timestamped_filename+".csv","wb")
    ...
    if latest=="long":
        finalfile = open("data/gigs/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        outputfile = open("data/gigs/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        outputfile = open("data/gigs/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        finalfile = open("data/gigs/"+city+"/final_"+city+"_"+timestamped_filename+".csv","wb")
        ...
        newfile = open("data/gigs/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        finalfile = open("data/gigs/"+city+"/final_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        if (latest[0]!="data/gigs/"+city+"/"+city+"_"+timestamped_filename+".csv"):
            os.remove(latest[0])
        os.remove("data/gigs/"+city+"/final_"+city+"_"+timestamped_filename+".csv")
    os.remove("data/gigs/"+city+"/new_"+city+"_"+timestamped_filename+".csv")
