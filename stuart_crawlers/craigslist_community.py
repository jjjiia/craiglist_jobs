...
def get_latest():
    ...
    for i in range(14):
        ...
        filename = "data/community/"+city+"/"+city+"_"+prevday+".csv"
        print filename
...
def download_craigslist(page_count = 1, limit = 5):
    ...
    for i in range(page_count):
        link = 'http://'+city+'.craigslist.org/ccc/index' + str(i*100) + '.html'
...
for city in cities:
    ...
    if not os.path.exists("data/community/"+city):
        os.makedirs("data/community/"+city)
    print city

    

    titles = []
    outputfile = open("data/community/"+city+"/new_"+city+"_"+timestamped_filename+".csv","wb")
    ...
    if latest=="long":
        finalfile = open("data/community/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        outputfile = open("data/community/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        outputfile = open("data/community/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        finalfile = open("data/community/"+city+"/final_"+city+"_"+timestamped_filename+".csv","wb")
        ...
        newfile = open("data/community/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        finalfile = open("data/community/"+city+"/final_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        if (latest[0]!="data/community/"+city+"/"+city+"_"+timestamped_filename+".csv"):
            os.remove(latest[0])
        os.remove("data/community/"+city+"/final_"+city+"_"+timestamped_filename+".csv")
    os.remove("data/community/"+city+"/new_"+city+"_"+timestamped_filename+".csv")
