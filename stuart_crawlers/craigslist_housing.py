...
def get_latest():
    ...
    for i in range(14):
        ...
        filename = "data/housing/"+city+"/"+city+"_"+prevday+".csv"
        print filename
...
def download_craigslist(page_count = 1, limit = 5):
    ...
    for i in range(page_count):
        link = 'http://'+city+'.craigslist.org/hhh/index' + str(i*100) + '.html'
...
for city in cities:
    ...
    if not os.path.exists("data/housing/"+city):
        os.makedirs("data/housing/"+city)
    print city
    ...
    if latest=="long":
        finalfile = open("data/housing/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        outputfile = open("data/housing/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        outputfile = open("data/housing/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        finalfile = open("data/housing/"+city+"/final_"+city+"_"+timestamped_filename+".csv","wb")
        ...
        newfile = open("data/housing/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        finalfile = open("data/housing/"+city+"/final_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        if (latest[0]!="data/housing/"+city+"/"+city+"_"+timestamped_filename+".csv"):
            os.remove(latest[0])
        os.remove("data/housing/"+city+"/final_"+city+"_"+timestamped_filename+".csv")
    os.remove("data/housing/"+city+"/new_"+city+"_"+timestamped_filename+".csv")
