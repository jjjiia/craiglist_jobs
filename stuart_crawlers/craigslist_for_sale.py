...
def get_latest():
    ...
    for i in range(14):
        ...
        filename = "data/for_sale/"+city+"/"+city+"_"+prevday+".csv"
        print filename
...
for city in cities:
    ...
    if not os.path.exists("data/for_sale/"+city):
        os.makedirs("data/for_sale/"+city)
    print city

    

    titles = []
    outputfile = open("data/for_sale/"+city+"/new_"+city+"_"+timestamped_filename+".csv","wb")
    ...
    if latest=="long":
        finalfile = open("data/for_sale/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        outputfile = open("data/for_sale/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        outputfile = open("data/for_sale/"+city+"/new_"+city+"_"+timestamped_filename+".csv","rb")
        finalfile = open("data/for_sale/"+city+"/final_"+city+"_"+timestamped_filename+".csv","wb")
        ...
        newfile = open("data/for_sale/"+city+"/"+city+"_"+timestamped_filename+".csv","wb")
        finalfile = open("data/for_sale/"+city+"/final_"+city+"_"+timestamped_filename+".csv","rb")
        ...
        if (latest[0]!="data/for_sale/"+city+"/"+city+"_"+timestamped_filename+".csv"):
            os.remove(latest[0])
        os.remove("data/for_sale/"+city+"/final_"+city+"_"+timestamped_filename+".csv")
    os.remove("data/for_sale/"+city+"/new_"+city+"_"+timestamped_filename+".csv")
